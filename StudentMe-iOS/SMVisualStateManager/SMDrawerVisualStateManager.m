...
@implementation SMDrawerVisualStateManager

+ (SMDrawerVisualStateManager *)sharedManager {
    static SMDrawerVisualStateManager *_sharedManager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedManager = [[SMDrawerVisualStateManager alloc] init];
